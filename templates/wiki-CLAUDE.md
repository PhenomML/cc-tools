...
1. Append to `log.md`: what changed, what's pending
2. If factual knowledge was generated (tool behavior, patterns, upstream findings), write or update the relevant wiki page
3. If private memory files were updated, check whether the content belongs in the wiki instead (or as well)
4. Add an entry to `INDEX.md` for any new page created this session — one line with `#tags`
