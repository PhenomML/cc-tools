...
*Companion pieces: ["The Multi-Subject Personal Research Wiki"](https://github.com/PhenomML/cc-tools/blob/main/articles/multi-subject-personal-research-wiki.md) covers the wiki architecture and the skills that maintain it. ["The Research Brief"](https://github.com/PhenomML/cc-tools/blob/main/articles/the-research-brief.md) covers the rapid brief pattern — a subject-oriented wiki assembled in a single session for a meeting or time-sensitive question. ["Jupyter and the MCP Trade-off"](https://github.com/PhenomML/cc-tools/blob/main/articles/jupyter-and-the-mcp-tradeoff.md) covers when live notebook execution is worth its token cost and when shell-based conversion is sufficient.*
