...
A previous piece introduced the idea of making AI work permanent: instead of asking an
agent to answer questions, ask it to write files and commit the outputs. The natural
destination for this work, in a research context, is a wiki — a structured, interlinked
collection of markdown pages that the agent writes and maintains over time.
